...
myApp.directive('header', function ($compile, $http, TemplateFactory, TemplateService) {
    ...
    var loadCssUrl = "";
    var HeaderTemplate = "";
    //var LoadTemplate = TemplateFactory.HeaderTemplate().then(function (data) {
    //    HeaderTemplate = data;
    //});

    var linker = function (scope, element, attrs) {

        var HeaderTemplate = TemplateFactory.HeaderTemplate();
...
//      $routeProvider.
//        when('/About', {
//            template: '<data-about></data-about>',
//            controller: 'MyCtrl'
//        }).
//        when('/Contact', {
//            template: '<data-contact></data-contact>',
//            controller: 'MyCtrl'
//        }).
//        otherwise({
//            template: '<data-about></data-about>',
